...
Some global element-ui style modifications can be set in [@/src/styles/element-ui.scss](https://github.com/PAXFE/vue-element-admin/blob/master/src/styles/element-ui.scss).
...
First download [custom-element-theme](https://github.com/PAXFE/custom-element-theme)
...
::: tip
If you need to modify the name of the package generation style namespace, just modify the [variable](https://github.com/PAXFE/custom-element-theme/blob/master/gulpfile.js#L6).
:::
