...
项目里所有的请求都会走`@/utils/request.js`里面创建的的 axios 实例，它统一做了错误处理，[完整代码](https://github.com/PAXFE/pax-admin/blob/master/src/utils/request.js)。
...
::: tip
监听错误：[@/errorLog.js](https://github.com/PAXFE/pax-admin/blob/master/src/errorLog.js)

错误展示组件：[@/components/ErrorLog](https://github.com/PAXFE/pax-admin/blob/master/src/components/ErrorLog/index.vue)
:::
