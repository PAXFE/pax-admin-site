...
::: tip unique-opened
你可以在[Sidebar/index.vue](https://github.com/PAXFE/pax-admin/blob/master/src/layout/components/Sidebar/index.vue)中设置`unique-opened`来控制侧边栏，是否只保持一个子菜单的展开。
:::

## 多级目录(嵌套路由)

如果你的路由是多级目录，如本项目 [@/views/nested](https://github.com/PAXFE/pax-admin/tree/master/src/views/nested) 那样， 有三级路由嵌套的情况下，不要忘记还要手动在二级目录的根文件下添加一个 `<router-view>`。

如：[@/views/nested/menu1/index.vue](https://github.com/PAXFE/pax-admin/blob/master/src/views/nested/menu1/index.vue)，原则上有多少级路由嵌套就需要多少个`<router-view>`。
...
```js
// redirect.vue
// https://github.com/PAXFE/pax-admin/blob/master/src/views/redirect/index.vue
export default {
  beforeCreate() {
...
::: tip 代码地址
[@/components/Breadcrumb](https://github.com/PAXFE/pax-admin/blob/master/src/components/Breadcrumb/index.vue)
:::
...
::: tip 代码地址
[@/components/Sidebar](https://github.com/PAXFE/pax-admin/blob/master/src/views/layout/components/Sidebar/index.vue)
:::
...
```json
{
  ...
  "children": [
    {
      "path": "https://github.com/PAXFE/pax-admin",
