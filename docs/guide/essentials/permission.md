...
Just one more step to map the back-end return routing table with the local components. [issue](https://github.com/PAXFE/vue-element-admin/issues/293)
...
Write a permission directive, and can easily and quickly implement button-level permission judgment. [v-permission](https://github.com/PAXFE/vue-element-admin/tree/master/src/directive/permission)
