...
All the requests in the project will go through the axios instance created in `@/utils/request.js`. [code](https://github.com/PAXFE/vue-element-admin/blob/master/src/utils/request.js)。
...
::: tip
Listening error: [@/errorLog.js](https://github.com/PAXFE/vue-element-admin/blob/master/src/errorLog.js)

Error display component: [@/components/ErrorLog](https://github.com/PAXFE/vue-element-admin/blob/master/src/components/ErrorLog/index.vue)
:::
