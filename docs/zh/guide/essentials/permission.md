...
只是多了一步将后端返回路由表和本地的组件映射到一起。相关[issue](https://github.com/PAXFE/vue-element-admin/issues/293)
...
封装了一个指令权限，能简单快速的实现按钮级别的权限判断。 [v-permission](https://github.com/PAXFE/vue-element-admin/tree/master/src/directive/permission)
